...
/**
 * This is the item provider adapter for a {@link mm1.Question} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Question_ennonce_feature",
								"_UI_Question_type"),
						Mm1Package.Literals.QUESTION__ENNONCE, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Question_difficulte_feature",
								"_UI_Question_type"),
						Mm1Package.Literals.QUESTION__DIFFICULTE, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Question_reponsesMultiples_feature",
								"_UI_Question_type"),
						Mm1Package.Literals.QUESTION__REPONSES_MULTIPLES, true, false, false,
