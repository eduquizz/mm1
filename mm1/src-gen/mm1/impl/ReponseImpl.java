 ...
 * </p>
 * <ul>
 *   <li>{@link mm1.impl.ReponseImpl#getTexte <em>Texte</em>}</li>
 *   <li>{@link mm1.impl.ReponseImpl#isEstVraie <em>Est Vraie</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReponseImpl extends MinimalEObjectImpl.Container implements Reponse {
	...
	protected EClass eStaticClass() {
		return Mm1Package.Literals.REPONSE;
	}
	...
	public void setTexte(String newTexte) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Mm1Package.REPONSE__TEXTE, oldTexte, texte));
	}
	...
	public void setEstVraie(boolean newEstVraie) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Mm1Package.REPONSE__EST_VRAIE, oldEstVraie,
					estVraie));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case Mm1Package.REPONSE__TEXTE:
			return getTexte();
		case Mm1Package.REPONSE__EST_VRAIE:
			return isEstVraie();
		}
